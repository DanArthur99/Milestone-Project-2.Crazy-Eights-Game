...
API data fetch test |API fetches the data in from the Deck of Cards API|Pause code and console.log(response)|![API Response](docs/readme-images/API-response.png)|Pass
